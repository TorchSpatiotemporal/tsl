...
class BiRNNImputerModel(BaseModel):
    ...
    def forward(self, x: Tensor, input_mask: Tensor,
        ...
        if return_predictions:
            x_hat_fwd = rearrange(x_hat_fwd, f'{self._to_pattern} -> b t n f',
                                  n=nodes)
            x_hat_bwd = rearrange(x_hat_bwd, f'{self._to_pattern} -> b t n f',
                                  n=nodes)
    ...
    def predict(self, x: Tensor, input_mask: Tensor,
        ...
        """"""
        return self.forward(x=x, input_mask=input_mask, u=u,
                            return_hidden=False, return_predictions=False)
