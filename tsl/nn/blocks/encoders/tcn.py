...
class TemporalConvNet(nn.Module):
    ...
    Args:
        ...
        exponential_dilation (bool, optional): Whether to increase exponentially
            the dilation factor at each layer.
        weight_norm (bool, optional): Whether to apply weight normalization
            to the temporal convolutional filters.
        causal_padding (bool, optional): Whether to pad the input sequence
            to preserve causality.
        bias (bool, optional): Whether to add a learnable bias to the output.
        channel_last (bool, optional): If `True` input must have layout (b s n c),
            (b c n s) otherwise.
    """
