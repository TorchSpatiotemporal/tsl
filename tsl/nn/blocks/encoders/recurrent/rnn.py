...
from tsl.nn.layers.recurrent import LSTMCell, GRUCell, StateType
...
class RNNI(RNNIBase):
    ...
    def preprocess_input(self, x: Tensor, x_hat: Tensor, input_mask: Tensor,
                         step: int, u: Optional[Tensor] = None,
