...
def nmae(
    ...
    .. math::
        ...
        \text{NMAE} = \frac{\frac{1}{N} \sum_{i=1}^n
        |\hat{y}_i - y_i|}{\max(y) - \min(y)}
...
def nrmse_2(
    ...
    .. math::
        ...
        \text{NRMSE}_2 = \frac{\sqrt{\frac{\sum_{i=1}^n (\hat{y}_i - y_i)^2}{n}} }
        {\sum_{i=1}^n y_i^2}
...
def r2(
    ...
    Args:
        ...
        nan_to_zero (bool): If :obj:`True`, then masked values in output are
            ...
            not :obj:`None` and :attr:`reduction` is :obj:`'none'`.
            (default: :obj:`False`)
        mean_axis (int, Tuple, optional): the axis along which
            the mean of y is computed, to compute the variance of y
